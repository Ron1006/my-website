                        ...
                        <div className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <p className="text-gray-400">021-2316-024</p>
                                </div>
                                <div>
                                    <h4 className="text-white font-semibold text-lg mb-2">Office</h4>
                                    <p className="text-gray-400">Mount Maunganui, Tauranga, New Zealand</p>
                                </div>
                            </div>
